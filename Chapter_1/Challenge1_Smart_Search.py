...
class Search():
    ...
    def draw_map(self, last_known):
        ...
        cv.moveWindow('Search Area', 900, 0) #display in the upper-right corner
        cv.waitKey(500) #image first, and then game menu after 500 milliseconds
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob, \
        ...
        coords2 = [x for x in coords if x not in search_list] #smart search
        coords2 = coords2[:int((len(coords) * effectiveness_prob))]
        search_list += coords2
        loc_actual = (self.sailor_actual[0], self.sailor_actual[1])
        if area_num == self.area_actual and loc_actual in coords2:
            return 'Found in Area {}.'.format(area_num), coords2, search_list
        return 'Not Found', coords2, search_list
...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            results_1, coords_1, search_list_1 = app.conduct_search(1, app.sa1, app.sep1, search_list_1)
            results_2, coords_2, search_list_1 = app.conduct_search(1, app.sa1, app.sep1, search_list_1)
            app.sep1 = (len(set(coords_1 + coords_2))) / (len(app.sa1)**2)
            app.sep2 = 0
            app.sep3 = 0

        elif choice == "2":
            results_1, coords_1, search_list_2 = app.conduct_search(2, app.sa2, app.sep2, search_list_2)
            results_2, coords_2, search_list_2 = app.conduct_search(2, app.sa2, app.sep2, search_list_2)
            app.sep1 = 0
            app.sep2 = (len(set(coords_1 + coords_2))) / (len(app.sa2)**2)
            app.sep3 = 0

        elif choice == "3":
            results_1, coords_1, search_list_3 = app.conduct_search(3, app.sa3, app.sep3, search_list_3)
            results_2, coords_2, search_list_3 = app.conduct_search(3, app.sa3, app.sep3, search_list_3)
            app.sep1 = 0
            app.sep2 = 0
